...
import { useEmotionHistoryStore } from '../store/emotionHistoryStore';
import type { EmotionHistoryEntry } from '../store/emotionHistoryStore';

const Insights = () => {
  const history = useEmotionHistoryStore((state) => state.history);

  const calculateEmotionFrequency = () => {
    const frequency: { [key: string]: number } = {};
    history.forEach((entry: EmotionHistoryEntry) => {
  ...
  const calculateEmotionTrends = () => {
    const trends = history.map((entry: EmotionHistoryEntry) => ({
